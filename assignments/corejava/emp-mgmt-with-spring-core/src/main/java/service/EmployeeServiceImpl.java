...
public class EmployeeServiceImpl implements EmployeeService {
   // EmployeeDaoImpl employeeDaoJdbc = new EmployeeDaoImpl();
    ...
    public void bulkImport() {
        ...
        String line = null;
        try {
            in = new BufferedReader(new FileReader("/Users/dhilli/codebase/lowes_javabootcamp-dih-batch2/assignments/corejava/emp-mgmt-with-spring-core/src/main/java/input.txt"));
