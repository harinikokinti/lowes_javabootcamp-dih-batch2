...
public class FundTransferServiceApplication implements CommandLineRunner {

	private static final Logger logger = LoggerFactory.getLogger(FundTransferServiceApplication.class);
